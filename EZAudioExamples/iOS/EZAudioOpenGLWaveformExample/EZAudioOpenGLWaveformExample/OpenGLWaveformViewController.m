...
- (void)viewDidLoad
{
   ...
   */
  // Background color
  self.audioPlot.backgroundColor = [UIColor colorWithRed: 0.114 green: 0.346 blue: 0.685 alpha: 1];
  // Waveform color
  self.audioPlot.color           = [UIColor colorWithRed: 0.796 green: 0.749 blue: 0.663 alpha: 1];
  // Plot type
