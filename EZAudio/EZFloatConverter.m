...
@implementation EZFloatConverter
...
BOOL EZFloatConverterToFloat(EZFloatConverter* THIS, AudioBufferList *sourceBuffer, float * const * targetBuffers, UInt32 frames) {
...
BOOL EZFloatConverterToFloatBufferList(EZFloatConverter* converter, AudioBufferList *sourceBuffer,  AudioBufferList *targetBuffer, UInt32 frames) {
    ...
    return EZFloatConverterToFloat(converter, sourceBuffer, targetBuffers, frames);
}

BOOL EZFloatConverterFromFloat(EZFloatConverter* THIS, float * const * sourceBuffers, AudioBufferList *targetBuffer, UInt32 frames) {
    if ( frames == 0 ) return YES;
...
BOOL EZFloatConverterFromFloatBufferList(EZFloatConverter* converter, AudioBufferList *sourceBuffer, AudioBufferList *targetBuffer, UInt32 frames) {
    ...
    return EZFloatConverterFromFloat(converter, sourceBuffers, targetBuffer, frames);
}
